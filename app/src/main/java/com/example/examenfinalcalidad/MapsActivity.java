...
import com.example.examenfinalcalidad.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String movimientoJson = intent.getStringExtra("DATA_MOVIMIENTO");
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title(movimiento.descripcion));
